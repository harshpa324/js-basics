...
if (answer.toLowerCase() === "y") {
  ...
  if (answer2 === "left") {
    console.log("Oops, you go left and fall of a bridge!GGs You lost!");
  } else {
    // right
    console.log("Nice bro! You go right and approach a bridge...");
    ...
    if (answer3 === "cross") {
      ...
      console.log(
        "You turn back and learn a lesson that if you have a way grab it otherwise you will lose just like today GGS."
      );
    }
  }
} else {
